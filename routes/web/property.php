...
Route::prefix('properties')->middleware(['auth'])->group(function () {
    ...
    Route::get('/export', [PropertyController::class, 'exportExcel'])->name('properties.export');
    Route::get('/export-pdf', [PropertyController::class, 'exportPdf'])->name('properties.export.pdf');
